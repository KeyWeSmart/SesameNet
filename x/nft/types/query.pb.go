...
func (*QueryDenomByNameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{10}
}
...
func (*QueryDenomByNameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{11}
}
...
func (*QueryDenomsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{12}
}
...
type QueryDenomsResponse struct {
	Denoms     []QueryDenom        `protobuf:"bytes,1,rep,name=denoms,proto3" json:"denoms"`
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
func (*QueryDenomsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{13}
}
...
func (m *QueryDenomsResponse) GetDenoms() []QueryDenom {
	if m != nil {
		return m.Denoms
	}
	return nil
...
func (*QueryNFTRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{14}
}
...
func (*QueryNFTResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{15}
}
...
type QueryDenomsOfAddressRequest struct {
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
}

func (m *QueryDenomsOfAddressRequest) Reset()         { *m = QueryDenomsOfAddressRequest{} }
func (m *QueryDenomsOfAddressRequest) String() string { return proto.CompactTextString(m) }
func (*QueryDenomsOfAddressRequest) ProtoMessage()    {}
func (*QueryDenomsOfAddressRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{16}
}
func (m *QueryDenomsOfAddressRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDenomsOfAddressRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDenomsOfAddressRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDenomsOfAddressRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDenomsOfAddressRequest.Merge(m, src)
}
func (m *QueryDenomsOfAddressRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryDenomsOfAddressRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDenomsOfAddressRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDenomsOfAddressRequest proto.InternalMessageInfo

func (m *QueryDenomsOfAddressRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
type QueryDenomsOfAddressResponse struct {
	Denoms []QueryDenom `protobuf:"bytes,1,rep,name=denoms,proto3" json:"denoms"`
}

func (m *QueryDenomsOfAddressResponse) Reset()         { *m = QueryDenomsOfAddressResponse{} }
func (m *QueryDenomsOfAddressResponse) String() string { return proto.CompactTextString(m) }
func (*QueryDenomsOfAddressResponse) ProtoMessage()    {}
func (*QueryDenomsOfAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{17}
}
func (m *QueryDenomsOfAddressResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDenomsOfAddressResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDenomsOfAddressResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDenomsOfAddressResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDenomsOfAddressResponse.Merge(m, src)
}
func (m *QueryDenomsOfAddressResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryDenomsOfAddressResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDenomsOfAddressResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDenomsOfAddressResponse proto.InternalMessageInfo

func (m *QueryDenomsOfAddressResponse) GetDenoms() []QueryDenom {
	if m != nil {
		return m.Denoms
	}
	return nil
...
type QueryDenomsAccessMapRequest struct {
	DenomId string `protobuf:"bytes,1,opt,name=denom_id,json=denomId,proto3" json:"denom_id,omitempty" yaml:"denom_id"`
}

func (m *QueryDenomsAccessMapRequest) Reset()         { *m = QueryDenomsAccessMapRequest{} }
func (m *QueryDenomsAccessMapRequest) String() string { return proto.CompactTextString(m) }
func (*QueryDenomsAccessMapRequest) ProtoMessage()    {}
func (*QueryDenomsAccessMapRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{18}
}
func (m *QueryDenomsAccessMapRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDenomsAccessMapRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDenomsAccessMapRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDenomsAccessMapRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDenomsAccessMapRequest.Merge(m, src)
}
func (m *QueryDenomsAccessMapRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryDenomsAccessMapRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDenomsAccessMapRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDenomsAccessMapRequest proto.InternalMessageInfo

func (m *QueryDenomsAccessMapRequest) GetDenomId() string {
	if m != nil {
		return m.DenomId
	}
	return ""
...
type QueryDenomsAccessMapResponse struct {
...
func (m *QueryDenomsAccessMapResponse) Reset()         { *m = QueryDenomsAccessMapResponse{} }
func (m *QueryDenomsAccessMapResponse) String() string { return proto.CompactTextString(m) }
func (*QueryDenomsAccessMapResponse) ProtoMessage()    {}
func (*QueryDenomsAccessMapResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bed4d0ceffe98642, []int{19}
}
func (m *QueryDenomsAccessMapResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDenomsAccessMapResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDenomsAccessMapResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDenomsAccessMapResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDenomsAccessMapResponse.Merge(m, src)
}
func (m *QueryDenomsAccessMapResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryDenomsAccessMapResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDenomsAccessMapResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDenomsAccessMapResponse proto.InternalMessageInfo

func (m *QueryDenomsAccessMapResponse) GetAccessMap() map[string]bool {
	if m != nil {
		return m.AccessMap
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryDenomByNameRequest)(nil), "sesamenet.nft.QueryDenomByNameRequest")
	proto.RegisterType((*QueryDenomByNameResponse)(nil), "sesamenet.nft.QueryDenomByNameResponse")
	proto.RegisterType((*QueryDenomsRequest)(nil), "sesamenet.nft.QueryDenomsRequest")
	proto.RegisterType((*QueryDenomsResponse)(nil), "sesamenet.nft.QueryDenomsResponse")
	proto.RegisterType((*QueryNFTRequest)(nil), "sesamenet.nft.QueryNFTRequest")
	proto.RegisterType((*QueryNFTResponse)(nil), "sesamenet.nft.QueryNFTResponse")
	proto.RegisterType((*QueryDenomsOfAddressRequest)(nil), "sesamenet.nft.QueryDenomsOfAddressRequest")
	proto.RegisterType((*QueryDenomsOfAddressResponse)(nil), "sesamenet.nft.QueryDenomsOfAddressResponse")
	proto.RegisterType((*QueryDenomsAccessMapRequest)(nil), "sesamenet.nft.QueryDenomsAccessMapRequest")
	proto.RegisterType((*QueryDenomsAccessMapResponse)(nil), "sesamenet.nft.QueryDenomsAccessMapResponse")
	proto.RegisterMapType((map[string]bool)(nil), "sesamenet.nft.QueryDenomsAccessMapResponse.AccessMapEntry")
}
...
var fileDescriptor_bed4d0ceffe98642 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	DenomsOfAddress(ctx context.Context, in *QueryDenomsOfAddressRequest, opts ...grpc.CallOption) (*QueryDenomsOfAddressResponse, error)
	// Queries a list of DenomsAccessMap items.
	DenomsAccessMap(ctx context.Context, in *QueryDenomsAccessMapRequest, opts ...grpc.CallOption) (*QueryDenomsAccessMapResponse, error)
}
...
func (c *queryClient) DenomByName(ctx context.Context, in *QueryDenomByNameRequest, opts ...grpc.CallOption) (*QueryDenomByNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sesamenet.nft.Query/DenomByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Denoms(ctx context.Context, in *QueryDenomsRequest, opts ...grpc.CallOption) (*QueryDenomsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sesamenet.nft.Query/Denoms", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) NFT(ctx context.Context, in *QueryNFTRequest, opts ...grpc.CallOption) (*QueryNFTResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sesamenet.nft.Query/NFT", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DenomsOfAddress(ctx context.Context, in *QueryDenomsOfAddressRequest, opts ...grpc.CallOption) (*QueryDenomsOfAddressResponse, error) {
	out := new(QueryDenomsOfAddressResponse)
	err := c.cc.Invoke(ctx, "/sesamenet.nft.Query/DenomsOfAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DenomsAccessMap(ctx context.Context, in *QueryDenomsAccessMapRequest, opts ...grpc.CallOption) (*QueryDenomsAccessMapResponse, error) {
	out := new(QueryDenomsAccessMapResponse)
	err := c.cc.Invoke(ctx, "/sesamenet.nft.Query/DenomsAccessMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// Queries a list of DenomsOfAddress items.
	DenomsOfAddress(context.Context, *QueryDenomsOfAddressRequest) (*QueryDenomsOfAddressResponse, error)
	// Queries a list of DenomsAccessMap items.
	DenomsAccessMap(context.Context, *QueryDenomsAccessMapRequest) (*QueryDenomsAccessMapResponse, error)
}
...
func (*UnimplementedQueryServer) DenomsOfAddress(ctx context.Context, req *QueryDenomsOfAddressRequest) (*QueryDenomsOfAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DenomsOfAddress not implemented")
}
func (*UnimplementedQueryServer) DenomsAccessMap(ctx context.Context, req *QueryDenomsAccessMapRequest) (*QueryDenomsAccessMapResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DenomsAccessMap not implemented")
}
...
func _Query_DenomByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sesamenet.nft.Query/DenomByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Denoms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sesamenet.nft.Query/Denoms",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_NFT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sesamenet.nft.Query/NFT",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DenomsOfAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryDenomsOfAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).DenomsOfAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sesamenet.nft.Query/DenomsOfAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).DenomsOfAddress(ctx, req.(*QueryDenomsOfAddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_DenomsAccessMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryDenomsAccessMapRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).DenomsAccessMap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sesamenet.nft.Query/DenomsAccessMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).DenomsAccessMap(ctx, req.(*QueryDenomsAccessMapRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DenomsOfAddress",
			Handler:    _Query_DenomsOfAddress_Handler,
		},
		{
			MethodName: "DenomsAccessMap",
			Handler:    _Query_DenomsAccessMap_Handler,
		},
	},
...
func (m *QueryDenomsOfAddressRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDenomsOfAddressRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDenomsOfAddressRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryDenomsOfAddressResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDenomsOfAddressResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDenomsOfAddressResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryDenomsAccessMapRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDenomsAccessMapRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDenomsAccessMapRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryDenomsAccessMapResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDenomsAccessMapResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDenomsAccessMapResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryDenomsOfAddressRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDenomsOfAddressResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDenomsAccessMapRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDenomsAccessMapResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDenomsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Denoms = append(m.Denoms, QueryDenom{})
...
func (m *QueryDenomsOfAddressRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDenomsOfAddressRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDenomsOfAddressRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryDenomsOfAddressResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDenomsOfAddressResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDenomsOfAddressResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryDenomsAccessMapRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDenomsAccessMapRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDenomsAccessMapRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryDenomsAccessMapResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDenomsAccessMapResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDenomsAccessMapResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 6:
			if wireType != 2 {
