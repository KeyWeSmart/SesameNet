...
var (
	...
	pattern_Query_Denom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sesamenet", "nft", "denoms", "id", "denom_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DenomByName_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sesamenet", "nft", "denoms", "name", "denom_name"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DenomsOfAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 3}, []string{"sesamenet", "nft", "denoms", "address"}, "", runtime.AssumeColonVerbOpt(true)))
