...
MNEMONIC4="squeeze online orchard option tiny duty vapor body learn ensure term anger space miracle nerve clerk circle tonight chair desk steel burst glare accident"
...
sesame init node4 --chain-id $CHAIN_ID --home ./node4
...
sesame config chain-id $CHAIN_ID --home ./node4
sesame config keyring-backend test --home ./node4
sesame config broadcast-mode block --home ./node4
...
echo $MNEMONIC4 | sesame keys add node4 --home ./node0 --recover
echo $MNEMONIC4 | sesame keys add node4 --home ./node4 --recover
...
sesame add-genesis-account node4 10000000ssc --home ./node0
sesame add-genesis-account node4 10000000ssc --home ./node4
...
sesame gentx node4 5000000ssc --home ./node4 --keyring-backend test --chain-id $CHAIN_ID --moniker node4
...
cp ./node4/config/gentx/* ./node0/config/gentx
...
cp ./node0/config/genesis.json ./node4/config/genesis.json
...
NODE4ID=$(sesame tendermint show-node-id --home ./node4)
