...
# init node
sesame init node0 --chain-id $CHAIN_ID --home ./node0 --staking-bond-denom ssc
sesame init node1 --chain-id $CHAIN_ID --home ./node1 --staking-bond-denom ssc
sesame init node2 --chain-id $CHAIN_ID --home ./node2 --staking-bond-denom ssc
sesame init node3 --chain-id $CHAIN_ID --home ./node3 --staking-bond-denom ssc
